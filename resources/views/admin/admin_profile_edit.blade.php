                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                               ...
                               <hr>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" id="name" placeholder="Name" id="name" value="{{$editData->name}}">
                                    </div>
                                </div>
                            ...
                            <hr>
                            <a class="btn btn-outline-success waves-effect waves-light" href="{{route('update.profile')}}">Update Profile</a>
                        </div>
                    </div> 
                </div>
            </div>
